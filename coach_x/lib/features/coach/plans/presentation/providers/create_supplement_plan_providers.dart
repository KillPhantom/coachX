...
/// 补剂计划仓库 Provider
final supplementPlanRepositoryProvider = Provider<SupplementPlanRepository>((ref) {
  return SupplementPlanRepository();
});

/// 创建补剂计划状态管理 Provider
final createSupplementPlanNotifierProvider =
    StateNotifierProvider<CreateSupplementPlanNotifier, CreateSupplementPlanState>((ref) {
